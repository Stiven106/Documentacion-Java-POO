...
public class TestInterfaces {
    public static void main(String[] args) {
        ...
        /*
        Para empezar a trabajar con los metodos definidos dentro de la clase IAccesoDatos, tendremos que tomar una
        ...
        imprimir(datos);
        /*
        Aclaracion line 20: Aplicaremos el polimorfismo, dado que aunque tenemos tres metodos en comun = datos.listar() que esta
        ...
        el del objeto al que esta apuntando la interface, en este caso es "ImplementacionMySQL" de forma que este tiene prioridad.
         */
    ...
    public static void imprimir (IAccesoDatos datos) {
        /*
        Nota: Fijate en el parametro del metodo. Recuerda que el parametro datos debe ser del mismo tipo de la interface que comunica, en este caso
        IAccesoDatos.
         */
        ...
        datos.listar();
        datos.eliminar();
        // Solo imprimen un texto, ya que asi fue su implementacion. 
    }
