...
public class TeoriaElementos {
    /*
        ...
        Scriptlets: Un scriplet puede tener codigo Java que no necesariamente va a visualizar el cliente. Demasiado codigo en un scriplet
        ...
        Declaraciones: El codigo que agreguemos, si es que agregamos una variable, se vuelve una variable de instancia. Debido a que se esta agregando
